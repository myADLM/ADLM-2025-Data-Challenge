...
To: THE FILE RE: DOCUMENT NUMBER k053196 Ischemia Technologies, Inc. Albumin Cobalt Binding Test (ACB® Test)

This 510(k) submission contains information/data on modifications made to the SUBMITTER’S own Class II, Class III or Class I devices requiring 510(k). The following items are present and acceptable (delete/add items as necessary):

1. The name and 510(k) number of the SUBMITTER’S previously cleared device. (For a preamendments device, a statement to this effect has been provided.) k023824
...
This change was to expand the chemistry analyzers suitable for use with the ACB Test to include the Roche Cobas Integra $\textsuperscript { \textregistered }$ 700/800 analyzer with modified bilirubin interference information in the labeling.
