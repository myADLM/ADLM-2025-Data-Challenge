...
To: THE FILE Abbott ARCHITECT $\textsuperscript { \textregistered }$ B12 Calibrators

RE: DOCUMENT NUMBER k053330

This 510(k) submission contains information/data on modifications made to the SUBMITTER’S own Class II, Class III or Class I devices requiring 510(k). The following items are present and acceptable (delete/add items as necessary):

1. The name and 510(k) number of the SUBMITTER’S previously cleared device. (For a preamendments device, a statement to this effect has been provided.) k984108
...
This change was to modify the number of calibrator materials provided in the device. The modified device consists of six calibrator materials. Calibrator A contains borate buffer. Calibrators B through F contain cyanocobalamine in borate buffer at 100, 250, 500, 1000, and $2 0 0 0 \mathsf { p g / m l }$ . The predicate device consists of two calibrator materials containing cyanocobalamine in borate buffer at 100 and $5 0 0 ~ \mathrm { p g / m L }$ .
