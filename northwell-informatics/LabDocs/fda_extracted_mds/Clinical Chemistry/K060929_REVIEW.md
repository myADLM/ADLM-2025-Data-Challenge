...
This $5 1 0 ( \mathrm { k } )$ submission contains information/data on modifications made to the SUBMITTER’S own Class II, Class III or Class I devices requiring 510(k). The following items are present and acceptable (delete/add items as necessary):
...
the addition of the IMMULITE $\textsuperscript { \textregistered }$ 2500 Vitamin B12 and IMMULITE $\textsuperscript { \textregistered }$ 2500 Folic Acid to the previously cleared (K033234) IMMULITE 2500 Automated Immunoassay Analyzer. In addition, the incubation times of these assays are being changed to provide a more rapid time to first result.
