...
3. A description of the device MODIFICATIONS, including user’s and/or service manuals in sufficient detail to demonstrate that the FUNDAMENTAL SCIENTIFIC TECHNOLOGY of the modified device has not changed. This change was for internal updates (i.e., value assignment procedure of TIBC in calibrator and procedures for determining reportable range) and updated performance claims for the TIBC Analysis using the VITROS Chemistry Products TIBC Kit.
