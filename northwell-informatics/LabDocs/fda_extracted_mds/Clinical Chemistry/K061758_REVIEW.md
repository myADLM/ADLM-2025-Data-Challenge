...
The modification to the device is a change in the capture antibody from a capture antibody bound to a bead in the predicate device to a capture antibody bound to a plastic tube in the submitted device.

4. Comparison Information (similarities and differences) to applicant’s legally marketed predicate device including, labeling, intended use, physical characteristics, and chemistry method.
