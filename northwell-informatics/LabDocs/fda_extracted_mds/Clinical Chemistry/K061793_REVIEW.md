...
4. Comparison Information (similarities and differences) to applicant’s legally marketed predicate device including, labeling, intended use, physical characteristics. Differences are the analyzer and the number of calibration pojnts (2 calibration points on the new device; 3 on the predicate device)
