...
1. The name and 510(k) number of the SUBMITTER’S previously cleared device. Cholesterol 1,2,3 k014018
...
This change was for a) from a corded to a cordless device b) software and user interface changes (instructions on the display designed to guide the user in the operation of the device).

4. Comparison Information (similarities and differences) to applicant’s legally marketed predicate device including, labeling, intended use, physical characteristics, user interface, and software.
...
Comments: The k014018 device was found to be substantial equivalent to the predicate device with the following limitations:
