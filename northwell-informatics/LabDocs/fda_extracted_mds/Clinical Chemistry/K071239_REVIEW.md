...
1. The name and 510(k) number of the SUBMITTERS previously cleared device. (For a preamendments device, a statement to this effect has been provided.) k913615 Roche Diagnostics Hitachi Urinary/CSF Protein Assay (formerly Boehringer Mannheim).   
...
This change was for the application of the Urinary/CSF Protein reagent on the COBAS Integra 400/700/800 analyzers and the introduction of a single level calibrator $( 2 0 0 \mathrm { m g / L } )$ that is automatically diluted by the instrument; the dilution ratios for this calibrator are: 1:1, 1:4, 1:20, and 1:40.
