...
RE: DOCUMENT NUMBER: k071507

This 510(k) submission contains information/data on modifications made to the SUBMITTER’S own Class II, Class III or Class I devices requiring 510(k). The following items are present and acceptable (delete/add items as necessary):

1. The name and 510(k) number of the SUBMITTER’S previously cleared device. (For a preamendments device, a statement to this effect has been provided.) Cholesterol: k981493 and k990688 ; HDL: k060617; Glucose: k013068
...
A. Combining 3 single test strips into 1 strip with 3 tests for cholesterol, HDL-cholesterol and glucose.   
B. Changing the name of device to PTS PANELS CHOL+HDL $\cdot ^ { + }$ GLU Panel Test Strips.   
C. Increasing the sample volume from 15 uL to 35 uL.   
D. Changing the time to obtain a test result from 1 minute for each test to approximately two minutes for all three tests.
