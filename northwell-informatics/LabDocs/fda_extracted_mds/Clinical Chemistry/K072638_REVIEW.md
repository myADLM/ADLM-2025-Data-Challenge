...
To: THE FILE RE: DOCUMENT NUMBER k072638 This 510(k) submission contains information/data on modifications made to the SUBMITTERS own Class II, Class III or Class I devices requiring 510(k). The following items are present and acceptable (delete/add items as necessary):

1. The name and $5 1 0 ( \mathrm { k } )$ number of the SUBMITTERS previously cleared device. (For a preamendments device, a statement to this effect has been provided.) k913615, Roche Diagnostics Hitachi Urinary/CSF Protein Assay (formerly Boehringer Mannheim).
...
This change was for the introduction of the rate (kinetic) assay in addition to the cleared endpoint assay for the Urinary/CSF Protein reagent on the Roche/Hitachi Analyzers.
