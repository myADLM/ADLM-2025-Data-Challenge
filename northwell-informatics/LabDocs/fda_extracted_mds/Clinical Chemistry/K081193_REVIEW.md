...
1. The name and 510(k) number of the SUBMITTER’S previously cleared device. (For a preamendments device, a statement to this effect has been provided.) Cobas Integra Analyzer and Cobas Integra Reagent Cassettes, k951595
...
a. Removal of Integra 700 as an analyzer for use with the assay.   
b. Removal of plasma as a sample type.   
c. Quantification of lipemia and hemolysis interferences by using indices for these interferences.   
d. Updated/Modified the lower measuring range to 1.7 umol/L (0.099 mg/dL).   
e. Calibrator assignment process designed to be in alignment with the US Doumas reference method.
