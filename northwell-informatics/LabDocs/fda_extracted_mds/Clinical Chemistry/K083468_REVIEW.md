...
1. The name and 510(k) number of the SUBMITTER’S previously cleared device. (For a preamendments device, a statement to this effect has been provided.) k080923
...
A. Change in calibration method implementing an auto-code test strip. B. Addition of reminder alarms.   
C. Addition of post-meal flagging.   
D. Change from two buttons to three buttons
