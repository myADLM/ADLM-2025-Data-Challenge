...
1. The name and 510(k) number of the SUBMITTER’S previously cleared device. (For a preamendments device, a statement to this effect has been provided.) Taidoc Technology Corporation, FORA V10 Blood Glucose Monitoring System, Model TD4244 (k090404)
...
Modification to the software to remove the one pre-set code from displaying on the screen, to having no coding information displayed when the test strip is inserted.
