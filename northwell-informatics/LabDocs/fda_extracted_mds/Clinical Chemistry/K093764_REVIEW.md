...
RE: DOCUMENT NUMBER k093764

This 510(k) submission contains information/data on modifications made to the SUBMITTER’S own Class II, Class III or Reserved Class I devices requiring 510(k). The following items are present and acceptable (delete/add items as necessary) for the SOLOV2 Blood Glucose Monitoring System:

1. The name and 510(k) number of Biotest Medical Corp.'s previously cleared device, SuperCheck 1, Blood Glucose Monitoring System, Model 6268 cleared under k091815. (For a preamendments device, a statement to this effect has been provided.)
