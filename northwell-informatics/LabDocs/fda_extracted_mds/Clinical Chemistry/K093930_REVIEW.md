...
3. A description of the device MODIFICATION (S), including clearly labeled diagrams, engineering drawings, photographs, user’s and/or service manuals in sufficient detail to demonstrate that the FUNDAMENTAL SCIENTIFIC TECHNOLOGY of the modified device has not changed. This change was for having the software to reside on a web server as opposed to a user’s PC. Additionally it is compatible only with the DIDGET meter, does not change meter settings and does not have a PDF print function.
