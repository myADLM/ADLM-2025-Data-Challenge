...
1. The name and 510(k) number of the SUBMITTER’S previously cleared device. (For a preamendments device, a statement to this effect has been provided.) Standard Diagnostics SD Check GOLD blood glucose monitoring system, k082683
...
 Widening the testing temperature from $1 0 { - } 4 0 ^ { \circ } \mathrm { C }$ to $1 0 { - } 4 5 ^ { \circ } \mathrm { C }$ .   
 Optional hypoglycemia warning function at 60, 70, or $8 0 ~ \mathrm { m g / d L }$   
