...
Re: k120197 Trade Name: ABL90 Flex Regulation Number: 21 CFR $\ S 8 6 2 . 1 1 2 0$ E Regulation Name: Blood Gases and blood $\mathsf { p H }$ test system Regulatory Class: Class II Product Codes: CHL, CEM, CGA, CGZ, GHS, GKR, JFP, JGS, JIX, KQI, JJY, KHP Dated: February 28, 2012 Received: March 2, 2012
...
Sodium $( \mathsf { c N a } ^ { + } )$ : sodium measurements are used in the diagnosis and treatment of aldosteronism, diabetes insipidus, adrenal hypertension, Addison's disease, dehydration, inappropriate antidiuretic secretion, or other diseases involving electrolyte imbalance.

Calcium $( \mathsf { c C a } ^ { 2 + } )$ : clcium measurements are used in the diagnosis and treatment of parathyroid disease, a variety of bone diseases, chronic renal disease and tetany.
...
$\mathbf { s } \mathbf { O } _ { 2 }$ : oxygen saturation, more specifically the ratio between the concentration of oxyhemoglobin and oxyhemoglobin plus reduced hemoglobin.

$\mathrm { F O } _ { 2 } \mathrm { H b }$ : oxyhemoglobin as a fraction of total hemoglobin.
