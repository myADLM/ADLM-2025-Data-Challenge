...
Perform calibrations, · Perform replacements (initiates specific replacement procedures only), C Perform QC measurements, Edit data in the log files (edit patient demographics, input parameters and additional patient sample information (notes) in the log file only, no changes in any patient results), and P Approve patient results.
