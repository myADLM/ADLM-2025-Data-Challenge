...
1) Change in the amount of ingredients per test due to reduction in slide surface area. The change in the amount of reagents in is proportional for all ingredients due to reduced slide surface area. 2) Reduction in sample volume required per test.
