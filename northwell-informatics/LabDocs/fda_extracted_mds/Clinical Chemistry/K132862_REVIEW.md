...
RE: DOCUMENT NUMBER k132862

This 510(k) submission contains information/data on modifications made to the SUBMITTER’S own Class II, Class III or Class I devices requiring 510(k). The following items are present and acceptable (delete/add items as necessary):

1. The name and 510(k) number of the SUBMITTER’S previously cleared device. k113192 - Healthpro Blood Glucose Monitoring System.
...
This change was for 1) to add an additional name to their cleared system: Healthpro Professional Blood Glucose Monitoring System, 2) adding a patient ID function, 3) a modification of the graphic design of the test strip cover. Specifically, the test strip was modified by changing the shape of the arrow indicating the direction to insert the test strip, and by changing the color from blue to silver, 4) an addition to the name of their cleared controls: Healthpro Professional Glucose Control Solution, and 5) the addition of validated cleaning and disinfection instructions for multiple-patient use to the labeling.

3. Comparison Information (similarities and differences) to applicant’s legally marketed predicate device including, labeling, intended use, and physical characteristics.
