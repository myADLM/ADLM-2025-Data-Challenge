...
a. Addition of a Bluetooth module for the wireless transfer of data to mobile devices.   
b. Software (firmware) changes include addition of Bluetooth pairing function, Bluetooth data transfer function including automatic data transfer to ensure all data are transferred to the mobile device when Bluetooth function is on.   
c. The candidate device system is introduced with a new name “VeraSens Blood Glucose Monitoring System” in addition to the original predicate name “NoCoding1 Plus Blood Glucose Monitoring System”.
