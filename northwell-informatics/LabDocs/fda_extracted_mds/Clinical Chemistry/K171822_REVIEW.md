...
a. A change in the name of the device from the SuperCheck Plus Blood Glucose Monitoring System (Model 5228‐S) to the NuvoMed Wireless Blood Glucose Monitoring System (Model BGM-6/0352)   
b. New printed circuit board with new microcontroller unit   
c. Change to positive display liquid crystal display and reposition of the control test flag (cont) on meter display   
d. Change to Bluetooth mediated data transmission and removal of RS232 phone jack port for cable data download to personal computer   
e. An E_8 error message added to indicate that users fail to reset date and time after installing or changing batteries in device's "Start Up" mode   
f. Change of meter's housing color from black to white

4. Comparison Information (similarities and differences) to applicant’s legally marketed predicate device including, labeling, intended use, physical characteristics, and performance characteristics of the NuvoMed Wireless Blood Glucose Monitoring System (Model BGM-6/0352).
