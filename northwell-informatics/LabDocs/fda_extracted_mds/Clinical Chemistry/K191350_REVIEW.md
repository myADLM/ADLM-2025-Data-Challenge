...
ACTIVE $\textsuperscript { \textregistered }$ Free Testosterone RIA
...
1. The name and 510(k) number of the SUBMITTER'S previously cleared device, ACTIVE $\textsuperscript { \textregistered }$ Free Testosterone RIA (k952281).   
2. Submitter's statement that the INDICATIONS FOR USE/INTENDED USE of the modified device as described in its labeling HAS NOT CHANGED along with the proposed labeling which includes instructions for use, package labeling, and, if available, advertisements or promotional materials (labeling changes are permitted as long as they do not affect the intended use).

3. A description of the device MODIFICATION(S), including clearly labeled diagrams, engineering drawings, photographs, user's and/or service manuals in sufficient detail to demonstrate that the FUNDAMENTAL SCIENTIFIC TECHNOLOGY of the modified device has not changed. This change was for: A change in the polyclonal capture antibody.
