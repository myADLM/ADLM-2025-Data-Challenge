...
This change is for the addition of new parameters.

4. Comparison Information (similarities and differences) to applicant’s legally marketed predicate device including, labeling, intended use, physical characteristics, and stability. The control contains the addition of new parameters; RETC, $\%$ RETC, and IRF. In addition, the control formulation includes the addition of porcine reticulocytes.
