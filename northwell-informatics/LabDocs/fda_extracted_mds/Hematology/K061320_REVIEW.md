...
The change was for the addition of the Nucleated Red Blood Cell (nRBC) and $n { \mathsf { R B C \% } }$ parameters.

Comparison Information (similarities and differences) to applicant’s legally marketed predicate device including, labeling, intended use, physical characteristics, and stability. The difference is in the number of parameters available, addition of nRBC components.
