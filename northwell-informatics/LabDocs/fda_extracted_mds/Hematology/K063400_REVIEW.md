...
RE: DOCUMENT NUMBER k063400

This 510(k) submission contains information/data on modifications made to the SUBMITTER’S own Class II, Class III or Reserved Class I devices requiring 510(k). The following items are present and acceptable (delete/add items as necessary) for the Variant II Turbo Hemoglobin A1C Program, Hemoglobin Testing System with CDM 4.0:

1. The name and 510(k) number of BIO-RAD LABORATORIES, INC.'s previously cleared device, Bio - Rad Laboratories, Variant II Hemoglobin A1C, cleared under k040872. (For a preamendments device, a statement to this effect has been provided.)
...
This change was for a software version change for the Clinical Data Management (CDM) from Windows NT (ver. 3.6T) to Windows XP (ver. 4.0). Additionally data analysis algorithms are complied in an external software module and not programmed into the base CDM software as in 3.6T
