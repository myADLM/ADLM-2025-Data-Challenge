...
Both devices (Forsure and WHPM) are for the qualitative determination of the Fecal Occult Blood. The specific antibodies against human hemoglobin were used in both devices. All test devices are visually -read single use device. The cutoff of each analyte is same (50 ng/ml or 50 $\mu \mathbf { g } / \mathbf { g }$ of feces).
