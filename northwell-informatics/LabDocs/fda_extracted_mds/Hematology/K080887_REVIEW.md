...
The change was for the addition of the Urinalysis WAM (work area management) software system for data processing and LIS (Laboratory Information System) interface.

Comparison Information (similarities and differences) to applicant’s legally marketed predicate device including, labeling, intended use, physical characteristics, and stability. The difference is in the addition of the Urinalysis WAM software on the IPU.
