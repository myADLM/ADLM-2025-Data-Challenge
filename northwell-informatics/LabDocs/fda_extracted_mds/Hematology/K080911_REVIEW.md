...
The change was for the upgrade of the Genetic Data Management (GDM) software from version 2.01 to version 3.0. This upgrade includes a change in the operating system from Windows NT to Windows XP.

Comparison Information (similarities and differences) to applicant’s legally marketed predicate device including, labeling, intended use, physical characteristics, and stability. The difference is that the operating system will be Genetic Data Management (GDM) version 3.0 run on Microsoft Windows XP, and an upgrade to ObjectStore version 6.2 for data management.
