...
This change was for __software modifications, specifically (1) a change in the device on-board computer operating system software, without any change in the technology or mechanical operation by which samples are processed; (2) a change in the device application software to accommodate the new operating system and provide   
operator/user enhancements without logic configuration   
changes.

4. Comparison Information (similarities and differences) to applicant’s legally marketed predicate device including, labeling, intended use, physical characteristics, and _principles of operation.
