...
RE: DOCUMENT NUMBER K130860

This 510(k) submission contains information/data on modifications made to the SUBMITTER’S own Class II, Class III or Reserved Class I devices requiring 510(k). The following items are present and acceptable (delete/add items as necessary) for the VARIANT II Hemoglobin A1c Program (New), VARIANT II Hemoglobin Testing System With CDM Software:

1. The name and 510(k) number of Bio-Rad Laboratories’ previously cleared device VARIANT II Hemoglobin A1c Program, and VARIANT II -thalassemia Short Program, cleared under K070452 K063643 respectively.
