...
1. The name and 510(k) number of the SUBMITTER'S previously cleared device (K150041).
...
device has not changed. This change was to specify the environment of use for the TEG 6s Hemostasis System Citrated: K, KH, RT, FF Assay Cartridge.
