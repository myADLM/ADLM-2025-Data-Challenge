...
# HYDRASHIFT 2/4 daratumumab test (K172195)

2. Applicant’s statement that the INDICATION/INTENDED USE of the modified device as described in its labeling HAS NOT CHANGED along with the proposed labeling which includes instructions for use, package labeling, and, if available, advertisements or promotional materials. The labeling was updated with the the change to the Preparation section on page 5 to include “It contains anti-daratumumab total immunoglobulins from chinese hamster ovary cells.” The changes do not affect the intended use.

3. A description of the device MODIFICATION(S), including clearly labeled diagrams, engineering drawings, photographs, user’s and/or service manuals in sufficient detail to demonstrate that the FUNDAMENTAL SCIENTIFIC TECHNOLOGY of the modified device has not changed.

# This change was for :

a. Change of animal source for the raw material of the Ig Anti-daratumumab from murine (original material) to Chinese hamster ovary cells (new material).

4. Comparison Information (similarities and differences) to applicant’s legally marketed predicate device including, labeling, intended use, physical characteristics, and performance studies including concordance, sensitivity, and stabilitywas provided..
