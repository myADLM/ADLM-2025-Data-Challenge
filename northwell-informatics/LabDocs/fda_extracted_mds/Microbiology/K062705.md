...
Expected Results determined prior to the evaluation. The Synergies plus" GramPositive Panel demonstrated acceptable performance with an overall Essential Agreement of 98.8%, for both the Long Dilution Sequence and 4-Dilution Breakpoint Sequence, for Linezolid when compared with the frozen Reference panel.

Instrument reproducibility testing demonstrated acceptable reproducibility and precision for linezolid with Turbidity inoculum preparation method and the WalkAway® SI System or equivalent.
...
This particular submission is for the addition of the antimicrobial linezolid, at concentrations of 0.5 to $1 6 \mu \mathrm { g / m l }$ Long Dilution Sequence and $0 . 5 - 4 \mu \mathrm { g / m l }$ 4-Dilution Breakpoint Sequence, for enterococci and staphylococci, to the test panel.
