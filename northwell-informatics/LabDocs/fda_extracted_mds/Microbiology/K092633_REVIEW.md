...
1. The name and 510(k) number of the SUBMITTER’S previously cleared device: OSOM Influenza A&B (K061508)
...
3. The modification of the device consisted of expanded reactivity table to include reactivity information for the 2009 H1N1 Influenza strain A/Mexico/4108/2009). This modification has not had any effect or caused any changes to the FUNDAMENTAL SCIENTIFIC TECHNOLOGY of this device.

4. Comparison Information (similarities and differences):

Reactivity data was added to the analytical sensitivity table.   
There were no changes made to the device.
