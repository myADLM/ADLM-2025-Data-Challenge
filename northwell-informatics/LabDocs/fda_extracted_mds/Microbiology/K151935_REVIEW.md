...
This is a labeling change to remove a limitation for triglycerides as a potentially interfering substance. This labeling change does not affect the intended use or the instructions for use. There were no modifications to the device.

4. Comparison Information (similarities and differences) to applicant’s legally marketed predicate device including, labeling, intended use, physical characteristics, and interfering substances.
...
Based on the risk analysis, analytical validation was conducted to demonstrate that triglyceride levels up to $3 4 5 4 ~ { \mathrm { m g } } / { \mathrm { d L } }$ do not negatively affect device performance with whole blood, serum, or plasma sample types.
