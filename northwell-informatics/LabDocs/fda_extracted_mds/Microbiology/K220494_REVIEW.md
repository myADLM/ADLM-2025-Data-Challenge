...
A 510(k) Number K220494   
B Applicant Meridian Bioscience Israel Ltd.   
C Proprietary and Established Names BreathID Hp Lab System, BreathID Smart System   
...
device has not changed. The modifications include changes to cartridge reagents to increase shelf life and changes to Assay Definition File commands to accommodate reagent changes.
