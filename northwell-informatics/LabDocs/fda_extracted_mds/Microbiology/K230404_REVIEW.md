...
A 510(k) Number K230404   
B Applicant BioFire Diagnostics, LLC   
C Proprietary and Established Names BIOFIRE FILMARRY Gastrointestinal (GI) Panel   
...
3. A description of the device MODIFICATION(S), including clearly labeled diagrams, engineering drawings, photographs, user's and/or service manuals in sufficient detail to demonstrate that the FUNDAMENTAL SCIENTIFIC TECHNOLOGY of the modified device has not changed. The modifications include an update to the BIOFIRE GI Panel pouch module software to mitigate issues with false positive Cryptosporidium assay.
