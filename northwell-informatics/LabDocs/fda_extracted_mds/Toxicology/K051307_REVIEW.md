...
RE: DOCUMENT NUMBER K_051307

This 510(k) submission contains information/data on modifications made to the SUBMITTER’S own Class II, Class III or Class I devices requiring 510(k). The following items are present and acceptable (delete/add items as necessary):

1. The name and 510(k) number of the SUBMITTER’S previously cleared device. (For a preamendments device, a statement to this effect has been provided.) k023048
...
The modification involves a change to the reagent antibody. The reagent antibody has been modified for revalidation of drug cross-reactivity.
